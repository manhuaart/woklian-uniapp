...
<!--    <view class="line" v-if="addressList.length > 0">
        ...
        <view class="select-btn">
          <view class="checkbox-wrapper">
            <checkbox-group @change="radioChange(item.id)">
              <label class="well-check" style="display: flex; align-items: center;">
    ...
    <view class="footer acea-row row-between-wrapper">
      <view class="addressBnt " v-if="isWechat" @click="addAddress">
        <text class="iconfont icon-tianjiadizhi"></text>添加收货地址
      </view>
      <view class="addressBnt on" v-else @click="addAddress">
        <text class="iconfont icon-tianjiadizhi"></text>添加收货地址
      </view>
