 ...
 * 获取cityid
 * */
export function getCityIdStory(pro,city) {
	return request.get("/getCityByPCName?province="+pro+"&city="+city);
}
/**
 * 省市区
 */
 ...
 * 绑定沃卡
 * */
export function bandPhones(id,t) {
	return request.post("/wxapp/bindingNewTelphone", {
		phone: id,
		captcha: t
	});
}
...
*获取验证码
* */
export function getYzm(ph) {
	return request.post("/register/verifyNewTelphone",{
		phone: ph,
		type: 'bind'
	});
}
